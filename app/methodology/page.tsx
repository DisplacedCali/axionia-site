...
export const metadata = {
  title: "Methodology",
  description:
    "How Axionia adjusts a vendor's savings claim: selection bias, program overlap and evidence transfer — the attribution framework behind every report, written down.",
};
...
const ADJUSTMENTS = [
  ...
  },
  {
    ...
    body: "A new program rarely lands on empty ground. Care management, the PBM's clinical programs, the health plan's own outreach and an EAP may all touch the same member and the same claim. Each vendor counts the full saving. Added together, the savings claimed across a portfolio routinely exceed the total spend available to save.",
          ...
          <Reveal>
            <div className="max-w-2xl mb-12">
              ...
              <h2 className="font-serif font-light text-3xl md:text-5xl leading-tight">
                Four questions asked of every claim.
              </h2>
