      ...
      <Reveal>
        <div className="max-w-2xl mb-12">
          ...
          <h2 className="font-serif font-light text-3xl md:text-5xl leading-tight">
            Built for employers between{" "}
            <em className="italic">100 and 5,000 people.</em>
          </h2>
          <p className="mt-6 text-[16px] leading-[1.7] text-gray-warm">
            Big enough that benefit spend is a serious number — usually $1M to $60M a
            year — and small enough that there&rsquo;s no internal team whose job is to
            check it. It works best if you&rsquo;re self-funded or level-funded, because
            then the savings actually accrue to you rather than to a carrier.
          </p>
        </div>
      </Reveal>
